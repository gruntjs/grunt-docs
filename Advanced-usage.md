...
Note that a [tilde version range][] will be automatically specified in `package.json`. This is a good thing, as new patch releases of the latest version will be installable by npm.
...
Note that a [tilde version range][] will be automatically specified in `package.json`. This is a good thing, as new patch releases of the specified version will be installable by npm.
...
Note that regardless of the version you specify, a [tilde version range][] will be specified in `package.json`. This is a **very bad thing** in this case, as new—possibly incompatible—patch releases of the specified version will be automatically installed by npm, and your build will be broken.
