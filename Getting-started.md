...
_These instructions are written for grunt 0.4.x, but are still valid for grunt 0.3.x. Just note that for 0.3.x, plugin names and task configuration options may be different than what's shown in "The Gruntfile" section._
...
**[Gruntfile]**: This file is named `Gruntfile.js` or `Gruntfile.coffee` and is used to configure or define tasks and load grunt plugins. _This file was named `grunt.js` for 0.3.x versions of grunt._
