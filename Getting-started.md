...
**[Gruntfile]**: This file is named `grunt.js` for grunt 0.3.x and `Gruntfile.js` or `Gruntfile.coffee` for grunt 0.4.x and is used to configure or define tasks and load grunt plugins.
