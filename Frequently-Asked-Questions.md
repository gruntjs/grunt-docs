...
In order for the [qunit task](https://github.com/gruntjs/grunt-contrib-qunit) to work properly, [PhantomJS](http://www.phantomjs.org/) must be installed and in the system PATH (if you can run "phantomjs" at the command line, this task should work).
