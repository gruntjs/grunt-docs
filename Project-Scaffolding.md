...
_Note: This standalone utility used to be built-in to Grunt as the "init" task. See the Grunt [Upgrading from 0.3 to 0.4](https://gruntjs.com/upgrading-from-0.3-to-0.4) guide for more information about this change._
